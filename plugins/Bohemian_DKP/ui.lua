...
function E:AddConfigFrames(f)
    ...
    font:SetText("Boss Reward")


    local editboxBg = C:CreateFrame("Frame", "$parentEditBoxBossRewards", f, "TooltipBackdropTemplate")
    ...
    editbox:SetMultiLine(true)
    editbox:SetText(C:TableToConfigText(Bohemian_DKPConfig.bossRewards))
    ...
    Scroll = C:CreateFrame('ScrollFrame', '$parentEditBoxBossRewardsScroll', f, 'UIPanelScrollFrameTemplate')
    ...
    f.okay = function()
        Bohemian_DKPConfig.bossRewards = C:ConfigTextToTable(_G[name.."EditBoxBossRewardsBossRewards"]:GetText())
    end
    f.cancel = function()
        _G[name.."EditBoxBossRewardsBossRewards"]:SetText(C:TableToConfigText(Bohemian_DKPConfig.bossRewards))
    end
