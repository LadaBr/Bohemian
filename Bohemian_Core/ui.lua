...
function E:CreateInterfaceConfig()
    ...
    debug:SetChecked(Bohemian_CoreConfig.debug)
    ...
    font:SetText("Debug")
    local title, _ = E:AddConfigEditBox(f, {"TOPLEFT", f, "TOPLEFT", 30, -26}, "CpsLimit", "Bandwith", Bohemian_CoreConfig.cpsLimit, "CPS")

    BohemkaDKPInterfaceOptionsPanel.okay = function()
        Bohemian_CoreConfig.debug = BohemkaDKPInterfaceOptionsPanelDebug:GetChecked()
    end
    BohemkaDKPInterfaceOptionsPanel.cancel = function()
        BohemkaDKPInterfaceOptionsPanelDebug:SetChecked(Bohemian_CoreConfig.debug)
    end
