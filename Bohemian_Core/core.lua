...
function E:Load()
    Bohemian_CoreConfig.debug = Bohemian_CoreConfig.debug or false
    Bohemian_CoreConfig.cpsLimit = Bohemian_CoreConfig.cpsLimit or 3000
...
function E:FixGuildOfflineState()
    SetGuildRosterShowOffline(Bohemian_CoreConfig.showOffline)
    GuildFrameLFGButton:SetChecked(Bohemian_CoreConfig.showOffline)
end
